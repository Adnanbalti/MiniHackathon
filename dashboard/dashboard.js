    ...
    <div class="container">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    ...
                    <ul class="navbar-nav ms-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="../Profile/index.html">My Profile</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="../usersPage/usersPage.html">All Users</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarScrollingDropdown" role="button"
                                ...
                                <img src="../assets/avatarDummy.png" class="avatarDummy" alt="">
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                                <li><a class="dropdown-item" href="#">Profile View</a></li>
                                <li><a class="dropdown-item" href="../editProfile/editProfile.html">Edit Profile</a></li>
                                <li>
        ...
        <div class="row">
            <div class="col boxStyle">
                <img id="dashBoardPp" src="../assets/avatarDummy.png" class="profilePicture" alt="">
                <h5 id="userName">UserName</h5>
                <h5 id="emailAddress">User Email</h5>
                <h6 id="mobNum">User Mobile Number</h6>
                <h6 id="firstName">FirstName</h6>
                <h6 id="lastName">lastName</h6>
            </div>
            <div class="col-6 boxStyle">
                <div class="postInputArea">
                    <img class="pp" src="../assets/avatarDummy.png" class="profilePicture" alt="">
                    <input id="postInputBox" type="text" class="postInput">
                    <input type="file" id="uploadImageBtn">UploadImage
